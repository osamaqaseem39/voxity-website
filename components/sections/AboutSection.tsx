...
export default function AboutSection() {
  return (
    <section id="about" className="py-12 sm:py-16 md:py-20 relative grid-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="text-center mb-6 sm:mb-8">
            <p className="text-xs sm:text-sm md:text-base font-semibold text-[#e21b1b] uppercase tracking-wider mb-2 sm:mb-3">Who We Are</p>
          ...
          <div className="space-y-4 sm:space-y-6 text-sm sm:text-base md:text-lg lg:text-xl text-gray-300 leading-relaxed px-2">
            ...
            <p className="text-lg sm:text-xl md:text-2xl font-semibold text-[#e21b1b]">Web3 moves fast. We move faster.</p>
          </div>
        </motion.div>
      </div>
    </section>
